...
public class SendAndReceiveJsonAsyncTask extends AsyncTask<String, Void, String> {
    ...
    private JsonResponseCallback jsonResponseCallback = null;

    public SendAndReceiveJsonAsyncTask(Context context, JsonResponseCallback jsonResponseCallback) {
    ...
    protected void onPostExecute(String result) {
        ...
        jsonResponseCallback.onResponseReceived(result);
    }
}
